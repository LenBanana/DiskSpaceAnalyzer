...
public static class FileCopyOptionsMapper
{
    ...
    public static RobocopyOptions ToRobocopyOptions(FileCopyOptions generic)
    {
        var robocopy = new RobocopyOptions
        {
            ...
            // File selection
            IncludeFiles = new List<string>(generic.IncludeFiles),
            ExcludeDirectories = new List<string>(generic.ExcludeDirectories),
            ExcludeFiles = new List<string>(generic.ExcludeFiles),
    ...
    public static FileCopyOptions ToFileCopyOptions(RobocopyOptions robocopy)
    {
        var generic = new FileCopyOptions
        {
            ...
            // File selection
            IncludeFiles = new List<string>(robocopy.IncludeFiles),
            ExcludeDirectories = new List<string>(robocopy.ExcludeDirectories),
            ExcludeFiles = new List<string>(robocopy.ExcludeFiles),
        ...
        if (robocopy.CopyAll)
        {
            generic.ExtendedOptions["RobocopyCopyAll"] = true;
        }
