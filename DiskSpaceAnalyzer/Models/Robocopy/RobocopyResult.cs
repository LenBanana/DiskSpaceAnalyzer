...
public class RobocopyResult
{
    ...
    public List<RobocopyError> Errors { get; set; } = [];
    ...
    public List<string> FailedVerifications { get; set; } = [];

    /// <summary>Detailed information about files that failed verification.</summary>
    public List<VerificationFailureInfo> FailedVerificationDetails { get; set; } = [];
